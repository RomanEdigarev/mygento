...
const PoliticalModal: FC<Props> = ({showPoliticalModal, setShowPoliticalModal}) => {
  ...
  return (
    <div className={`${style.container} ${showPoliticalModal ? style.show : null}`}>
      <div className={style.contentPoliticalModal}>
        <button className={style.closeButton} onClick={closeModal}><span className="material-icons">close</span></button>
