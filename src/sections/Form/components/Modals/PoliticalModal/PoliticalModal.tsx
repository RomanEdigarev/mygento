...
type Props = {
    showPoliticalModal: boolean
    setShowPoliticalModal: Dispatch<boolean>
}

const PoliticalModal: FC<Props> = ({showPoliticalModal, setShowPoliticalModal}) => {
    ...
    return (
        <div className={`${style.container} ${showPoliticalModal ? style.show : ''}`}>
            <div className={`${style.contentPoliticalModal} ${showPoliticalModal ? style.show : ''}`}>
                <button className={style.closeButton} onClick={closeModal}><span className="material-icons">close</span>
                </button>
                <h1 className={style.politicalModalTitle}>
                    Политика конфиденциальности
                </h1>
                <div className={style.politicalModalTextWrapper}>
                    <p className={style.politicalModalText}>
